...
tag to tell browsers to render the gaps.
      ...
      <div id = "wd-images">
        ...
        <img id = "wd-starship" width = "400px" src = "https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" alt =""/>
      <br />
      Loading a local image: <br />
        <img id = "wd-teslabot" src="/images/teslabot.jpg" height = "200px" alt =""/> </div>
      </div>
      <div id="wd-forms">
  <h4>Form Elements</h4>
